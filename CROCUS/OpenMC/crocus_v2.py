...
Cadmium.add_nuclide("Cd113", percent=4.63334e-02, percent_type='ao')
...
ug_top_bot_surf  = openmc.ZPlane(ug_top_bot_dist, boundary_type = 'vacuum')
...
ug_region = ug_hex & +ug_bot_bot_surf & -ug_top_bot_surf
...
uo2_pi_top_cell     = openmc.Cell(region=(+uo2_fg_top_surf & -ug_top_bot_surf & -uo2_pi_clad_surf),                   fill = Clad_non_fuel)
uo2_pi_lg_bot_cell  = openmc.Cell(region=(+lg_bot_bot_surf & -lg_bot_top_surf & +uo2_pi_clad_surf),                   fill = Support_Material)
uo2_pi_lg_cad_cell  = openmc.Cell(region=(+lg_bot_top_surf & -lg_top_bot_surf & +uo2_pi_clad_surf),                   fill = Cadmium)
...
uo2_pi_ug_cad_cell  = openmc.Cell(region=(+ug_bot_top_surf & -ug_top_bot_surf & +uo2_pi_clad_surf),                   fill = Cadmium)
...
umet_pi_fg_cell      = openmc.Cell(region=(+fu_top_surf      & -ug_top_bot_surf  & -umet_pi_fu_surf),                      fill = Filler_Gas)
umet_pi_clad_cell    = openmc.Cell(region=(+fu_bot_surf      & -ug_top_bot_surf  & +umet_pi_fu_surf & -umet_pi_clad_surf), fill = Clad_umetal)
umet_pi_lg_bot_cell  = openmc.Cell(region=(+lg_bot_bot_surf  & -lg_bot_top_surf  & +umet_pi_clad_surf),                    fill = Support_Material)
umet_pi_lg_cad_cell  = openmc.Cell(region=(+lg_bot_top_surf  & -lg_top_bot_surf  & +umet_pi_clad_surf),                    fill = Cadmium)
...
umet_pi_ug_cad_cell  = openmc.Cell(region=(+ug_bot_top_surf  & -ug_top_bot_surf  & +umet_pi_clad_surf),                    fill = Cadmium)
...
# umet_empty_pi_air_cell     = openmc.Cell(region=(+wa_top_surf     & -ug_top_bot_surf & -umet_pi_clad_surf),                    fill = Air)
...
umet_empty_pi_lg_bot_cell  = openmc.Cell(region=(+lg_bot_bot_surf & -lg_bot_top_surf),                    fill = Support_Material)
umet_empty_pi_lg_clad_cell = openmc.Cell(region=(+lg_bot_top_surf & -lg_top_bot_surf),                    fill = Cadmium)
umet_empty_pi_lg_top_cell  = openmc.Cell(region=(+lg_top_bot_surf & -lg_top_top_surf),                    fill = Support_Material)
umet_empty_pi_ug_bot_cell  = openmc.Cell(region=(+ug_bot_bot_surf & -ug_bot_top_surf),                    fill = Support_Material)
umet_empty_pi_ug_clad_cell = openmc.Cell(region=(+ug_bot_top_surf & -ug_top_bot_surf),                    fill = Cadmium)
umet_empty_pi_bot_mod_cell = openmc.Cell(region=(+bp_top_surf     & -lg_bot_bot_surf),                    fill = Moderator)
umet_empty_pi_top_mod_cell = openmc.Cell(region=(+lg_top_top_surf & -wa_top_surf    ),                    fill = Moderator)
umet_empty_pi_bot_air_cell = openmc.Cell(region=(+wa_top_surf     & -ug_bot_bot_surf),                    fill = Air)
...
out_lg_cad_cell = openmc.Cell(region=(+lg_bot_top_surf & -lg_top_bot_surf & (+out_empty_crux_surf | (-out_inr_fu_cux_surf & +inr_fu_crux_surf)) & lg_hex), fill = Cadmium)
...
out_ug_cad_cell = openmc.Cell(region=(+ug_bot_top_surf & -ug_top_bot_surf & (+out_empty_crux_surf | (-out_inr_fu_cux_surf & +inr_fu_crux_surf)) & ug_hex), fill = Cadmium)
...
out_air_cell = openmc.Cell(region=(-ta_surf & +wa_top_surf & -ug_top_bot_surf & ~bp_region & ~lg_region & ~ug_region & (+out_empty_crux_surf | (-out_inr_fu_cux_surf & +inr_fu_crux_surf))), fill = Air)
